...
(function() {
    ...
    try {
        ...
        str = str.replace('w.gBrowser.selectedTab.pinned', '(!w.isTabEmpty(w.gBrowser.selectedTab) || [        DISCUZ_CODE_0        ])');
...
.replace(/\'command\' \=\= aEvent\.type/,"[        DISCUZ_CODE_0        ] \|\| aEvent\.button \=\= 1")
.replace(/\=\! script\.enabled\;\n/,"[        DISCUZ_CODE_0        ]aEvent.target.setAttribute('checked',script.enabled);\n")
.replace(/closeMenus/,"if(aEvent\.button \!\= 1) [        DISCUZ_CODE_0        ]"));
